...
class MatchScheduleTest extends TestCase
{
    ...
    public function test_organizer_can_schedule_match_between_eligible_teams(): void
    {
        ...
        $teamOne = $this->createEligibleTeam(
            $tournament,
            $game,
            'Team Nova'
        );
        ...
        $teamTwo = $this->createEligibleTeam(
            $tournament,
            $game,
            'Team Eclipse'
        );
        ...
        $response = $this
            ->actingAs($organizer)
            ->post(
                route('tournaments.matches.store', $tournament),
                [
                    'round' => 'Quarterfinal',
    ...
    public function test_team_without_verified_payment_cannot_be_scheduled(): void
    {
        $this->markTestSkipped(
            'Payment field removed from tournament schema'
        );
    }
    ...
    public function test_overlapping_schedule_for_same_team_is_rejected(): void
    {
        ...
        $teamThree = $this->createEligibleTeam(
            $tournament,
            $game,
            'Team Vertex'
        );
    ...
    public function test_match_status_transition_persists(): void
    {
        ...
        $response = $this
            ->actingAs($organizer)
            ->patch(
                route('matches.status.update',$match),
                [
                    'status'=>'ONGOING'
                ]
            );
